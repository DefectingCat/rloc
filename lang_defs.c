...
const Language g_languages[NUM_LANGUAGES] = {
    {.name = "Python",
     ...
     .content_patterns = "def ,class ,import ,from ,if __name__",
    ...
    {.name = "JavaScript",
     ...
     .filenames = NULL,
     .shebangs = "node",
     .content_patterns = "function ,var ,let ,const ,require(",
     .needs_content_check = false,
     .generic_filter_count = 1,
    ...
    {.name = "C",
     ...
     .filenames = NULL,
     .shebangs = NULL,
     .content_patterns = "int main,#include <,typedef ,struct ",
     .needs_content_check = false,
    ...
    {.name = "C++",
     ...
     .filenames = NULL,
     .shebangs = NULL,
     .content_patterns = "class ,namespace ,template <,public:",
     .needs_content_check = false,
     .generic_filter_count = 2,
    ...
    {.name = "Java",
     ...
     .filenames = NULL,
     .shebangs = NULL,
     .content_patterns = "public class,private class,import java,package ",
     .needs_content_check = false,
     .generic_filter_count = 2,
    ...
    {.name = "Go",
     ...
     .shebangs = NULL,
     .content_patterns = "package ,import ,func (,func main",
     .needs_content_check = false,
     .generic_filter_count = 1,
    ...
    {.name = "Rust",
     ...
     .filenames = NULL,
     .shebangs = NULL,
     .content_patterns = "fn ,let ,impl ,pub fn",
     .needs_content_check = false,
     .generic_filter_count = 2,
    ...
    {.name = "TypeScript",
     ...
     .filenames = NULL,
     .shebangs = NULL,
     .content_patterns = "interface ,type ,export ,declare ",
     .needs_content_check = false,
     .generic_filter_count = 2,
    ...
    {.name = "Ruby",
     ...
     .filenames = NULL,
     .shebangs = "ruby",
     .content_patterns = "def ,end,class ,require ",
     .needs_content_check = false,
     .generic_filter_count = 1,
    ...
    {.name = "PHP",
     ...
     .filenames = NULL,
     .shebangs = "php",
     .content_patterns = "$this->,<?php,function ,class ",
     .needs_content_check = false,
    ...
    {.name = "C#",
     ...
     .filenames = NULL,
     .shebangs = NULL,
     .content_patterns = "namespace ,public class,using ,private void",
     .needs_content_check = false,
     .generic_filter_count = 2,
    ...
    {.name = "Swift",
     ...
     .filenames = NULL,
     .shebangs = NULL,
     .content_patterns = "func ,let ,var ,class ",
     .needs_content_check = false,
     .generic_filter_count = 1,
    ...
    {.name = "Kotlin",
     ...
     .filenames = NULL,
     .shebangs = NULL,
     .content_patterns = "fun ,class ,val ,var ",
     .needs_content_check = false,
     .generic_filter_count = 1,
    ...
    {.name = "Shell",
     ...
     .content_patterns = "echo ,export ,if then,#!/",
     .needs_content_check = false,
     .generic_filter_count = 1,
    ...
    {.name = "Config",
     .extensions = "conf",
     .filenames =
         ".gitignore,.clang-format,.dockerignore,.editorconfig,.gitattributes,.gitmodules,.mailmap",
     .shebangs = NULL,
    ...
    {.name = "Perl",
     ...
     .filenames = NULL,
     .shebangs = "perl",
     .content_patterns = "sub ,my $,use ,package ",
     .needs_content_check = false,
     .generic_filter_count = 1,
    ...
    {.name = "CSS",
     ...
     .filenames = NULL,
     .shebangs = NULL,
     .content_patterns = "color:,margin:,padding:,font-",
     .needs_content_check = false,
     .generic_filter_count = 1,
    ...
    {.name = "HTML",
     ...
     .filenames = NULL,
     .shebangs = NULL,
     .content_patterns = "<html,<head,<body,<div",
     .needs_content_check = false,
     .generic_filter_count = 1,
    ...
    {.name = "SQL",
     ...
     .filenames = NULL,
     .shebangs = NULL,
     .content_patterns = "SELECT ,INSERT ,UPDATE ,CREATE ",
     .needs_content_check = false,
     .generic_filter_count = 1,
    ...
    {.name = "TOML",
     ...
     .filenames = NULL,
     .shebangs = NULL,
     .content_patterns = "[dependencies],[package],version =",
     .needs_content_check = false,
     .generic_filter_count = 1,
    ...
    {.name = "Vue",
     ...
     .filenames = NULL,
     .shebangs = NULL,
     .content_patterns = "<template,<script,<style,v-",
     .needs_content_check = false,
     .generic_filter_count = 1,
     .generic_filters = javascript_filters,
     .comment_hook = NULL,
    ...
    {.name = "XML",
     ...
     .filenames = NULL,
     .shebangs = NULL,
     .content_patterns = "<?xml,<tag>,</tag>,xmlns",
     .needs_content_check = false,
     .generic_filter_count = 1,
    ...
    {.name = "YAML",
     ...
     .filenames = NULL,
     .shebangs = NULL,
     .content_patterns = "- key:,key: value,---",
     .needs_content_check = false,
     .generic_filter_count = 1,
    ...
    {.name = "nginx",
     ...
     .shebangs = NULL,
     .content_patterns = "server {,location ,listen ,ngx.",
     .needs_content_check = false,
     .generic_filter_count = 1,
    ...
    {.name = "Lua",
     ...
     .filenames = NULL,
     .shebangs = "lua",
     .content_patterns = "local ,function,then,end",
     .needs_content_check = false,
     .generic_filter_count = 2,
...
int lang_show(const char* name) {
    ...
    if (g_custom_language_count > 0) {
        ...
        for (int i = 0; i < g_custom_language_count; i++) {
            printf("  %-12s  %s\n", g_custom_languages[i].name, g_custom_languages[i].extensions);
        }
    }
    return 0;
}
